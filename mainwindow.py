...
"color: rgb(255, 255, 255);")
        ...
        self.actionVuln_function_scanner = QtWidgets.QAction(MainWindow)
        self.actionVuln_function_scanner.setObjectName("actionVuln_function_scanner")
        self.actionDBG = QtWidgets.QAction(MainWindow)
        self.actionDBG.setObjectName("actionDBG")
        ...
        self.menuTools.addAction(self.actionVuln_function_scanner)
        self.menuTools.addAction(self.actionDBG)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionVuln_function_scanner.setText(_translate("MainWindow", "vuln function scanner"))
        self.actionVuln_function_scanner.setShortcut(_translate("MainWindow", "Ctrl+A"))
        self.actionDBG.setText(_translate("MainWindow", "J0llyDBG"))
        self.actionDBG.setShortcut(_translate("MainWindow", "F9"))
